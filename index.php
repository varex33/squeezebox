           ...
           <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                           <li class="current">
                                ...
                                <?php
                                    ...
                                    <img src='http://www.shumdesign.com/portfolio/wp-content/themes/squeezebox-master/img/img.png' alt='project image'>
                                    <?php }?>
                                    <div class='project-info'>
                                        <h2><a href="<?php the_permalink() ?>" class="link" rel="bookmark" title="Permanent Link to <?php the_title(); ?>"><?php the_title(); ?></a></h2>
                                        <p>Description of project:<br/><?php echo the_excerpt(); ?></p><span><?php  
